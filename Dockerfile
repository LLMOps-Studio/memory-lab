...
COPY MemoryLab/memory-lab ./MemoryLab/memory-lab

WORKDIR /workspace/MemoryLab/memory-lab
...
COPY --from=builder /workspace/MemoryLab/memory-lab /app

ENV PATH=/root/.local/bin:$PATH

EXPOSE 8000
CMD ["uvicorn", "memory_lab.api:app", "--host", "0.0.0.0", "--port", "8000"]
